...
class ProSearch extends Module {
    ...
    public function hookHeader($params) {
       if (Configuration::get('PS_SEARCH_AJAX'))
			...
			$this->context->controller->addCSS($this->_path.'css/prosearch.css');
		if (Configuration::get('PS_SEARCH_AJAX'))
		{
...
if (Tools::getValue('search_query') || !$this->isCached('prosearch_top.tpl', $key))
		{
            ...
            'prosearchmod' => __PS_BASE_URI__ . 'modules/prosearch/prosearchAjax.php',
        ...
        return $this->display(__FILE__, 'prosearch_top.tpl', Tools::getValue('search_query') ? null : $key);
    }
