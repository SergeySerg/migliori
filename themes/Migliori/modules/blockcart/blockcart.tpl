...
<div class="col-sm-3 mg_shopping_cart_wrap clearfix{if $PS_CATALOG_MODE} header_user_catalog{/if}">
{/if}
	<div class="shopping_cart">
		<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
			...
			<span class="cart-quant ajax_cart_total{if $cart_qties == 0} unvisible{/if}">
				{if $cart_qties > 0}
					{if $priceDisplay == 1}
			...
			<span class="cart-quant ajax_cart_no_product{if $cart_qties > 0} unvisible{/if}">{* {l s='(empty)' mod='blockcart'} *}0</span>
