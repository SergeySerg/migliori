...
<div id="viewed-products_block_left" class="block">
	<h3 class="mg_viewed_title">{l s='Viewed products' mod='blockviewed'}</h3>
	<div class="block_content products-block">
		<ul id="mg_viewed" class="owl-carousel">
			{foreach from=$productsViewedObj item=viewedProduct name=myLoop}
				<li class="clearfix{if $smarty.foreach.myLoop.last} last_item{elseif $smarty.foreach.myLoop.first} first_item{else} item{/if}">
					<a href="{$viewedProduct->product_link|escape:'html':'UTF-8'}" title="{l s='More about %s' mod='blockviewed' sprintf=[$viewedProduct->name|escape:'html':'UTF-8']}">
						<a
