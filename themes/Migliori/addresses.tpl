...
<h1 class="page-heading text-center">{l s='My addresses'}</h1>
<p class="text-center">{l s='Please configure your default billing and delivery addresses when placing an order. You may also add additional addresses, which can be useful for sending gifts or receiving an order at your office.'}</p>
{if isset($multipleAddresses) && $multipleAddresses}
<div class="addresses">
	<p class="text-center"><strong class="dark">{l s='Your addresses are listed below.'}</strong></p>
	<p class="p-indent text-center">{l s='Be sure to update your personal information if it has changed.'}</p>
...
<ul class="footer_links clearfix">
	<li>
		...
		{l s='Back to your account'}</a></li>
	<li>
		<a class="btn btn-default mg_btn" href="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}">{l s='Home'}</a></li>
</ul>
